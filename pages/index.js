      ...
      <main className=" bg-ivory-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-red-200 dark:text-gray-400">
            ...
            <div className="mx-auto bg-gradient-to-b from-azure rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-96 md:w-96">
        ...
        <section>
          <div>
            <h3 className="text-5xl py-1 dark:text-white ">Education</h3>
          </div>
