...
function ExperienceCard({experience}: Props) {
  return (
    ...
    w-[600px] h-[700px] max-md:h-[550px] max-md:w-[500px] xl:w-[900px] snap-center bg-[#F5EBE0] dark:bg-[#3F3B6C] pt-5 opacity-40 hover:opacity-100 transition-opacity duration-200 overflow-hidden'>
        <motion.div 
